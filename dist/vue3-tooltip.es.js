...
import { ref as u, openBlock as l, createElementBlock as r, normalizeClass as i, renderSlot as n, createVNode as p, Transition as f, withCtx as v, createCommentVNode as m } from "vue";
const _ = {
...
function T(t, e, o, a, s, $) {
  return l(), r("div", {
    onMouseenter: e[0] || (e[0] = (d) => a.isShowTooltip = !0),
    onMouseleave: e[1] || (e[1] = (d) => a.isShowTooltip = !1),
    ...
    p(f, {
      ...
      default: v(() => [
        !o.disable && a.isShowTooltip ? (l(), r("div", {
          key: 0,
...
const S = /* @__PURE__ */ y(_, [["render", T], ["__scopeId", "data-v-5991ce00"]]), k = {
  ...
  const o = "vue-tooltip";
  t.classList.add(o), !(e.value === null || e.value === void 0) && (t.dataset.tooltip = e.value, t.classList.add(`${o}-data`), t.classList.toggle(`${o}__${C(e.modifiers)}`, !0), t.classList.toggle(`${o}__${e.arg || "bottom"}`, !0));
